...
# -*- coding: utf-8 -*-
"""
YAML Karşılaştırma Web Arayüzü
FastAPI kullanarak web tabanlı YAML karşılaştırma uygulaması
"""
...
import uvicorn
from yaml_comparator import YamlComparator, YamlComparison
import json
from datetime import datetime

app = FastAPI(
    title="YAML Karşılaştırma Uygulaması",
    description="MongoDB ve Ollama AI kullanarak YAML dosyalarını karşılaştırır",
    version="1.0.0"
)
...
async def get_home():
    ...
    <head>
        ...
        <title>YAML Karşılaştırma Uygulaması</title>
        <style>
            * {
                margin: 0;
                padding: 0;
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>🔍 YAML Karşılaştırma Uygulaması</h1>
                <p>MongoDB ve Ollama AI ile güçlendirilmiş akıllı YAML analizi</p>
            </div>
...
database:
  ...
  port: 5432</div>
                ...
                <div id="loading" class="loading">
                    ...
                    <p>AI analizi yapılıyor, lütfen bekleyin...</p>
                </div>
                ...
                comparisons.forEach((comp, index) => {
                    ...
                    html += `
                        <div class="result-item">
                            ...
                            <div class="details-section">
                                <div class="details-title ai-analysis">AI Analizi</div>
...
@app.get("/rules")
async def get_rules():
    """Veritabanındaki kuralları döndürür"""
    global comparator
    ...
    try:
        rules = list(comparator.collection.find({}, {"_id": 1, "name": 1, "description": 1, "tags": 1}))
        return rules
    except Exception as e:
